      ...
      <div className="bg-white py-16 sm:py-24 md:py-32 lg:py-35 px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            {/* Reorder Favorites */}
            <div className={`text-center group transition-all duration-1000 px-4 sm:col-span-2 lg:col-span-1 ${isVisible.whyChoose ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
