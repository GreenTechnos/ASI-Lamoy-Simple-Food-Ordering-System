...
const CheckOutPage = () => {
  ...
  // Sample user information (static data)
  const sampleUserInfo = {
    name: 'Juan dela Cruz',
    number: '+63 912 345 6789',
    address: '123 Mabini Street, Barangay San Antonio, Manila City, Metro Manila 1000'
  };
  ...
  const handleCheckout = () => {
    // Process checkout (in real app, this would call an API)
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          >
            <div className="flex items-center space-x-2 text-sm text-gray-800">
              ...
              <span>/</span>
              <button onClick={() => navigate('/cart')} className="hover:text-yellow-600 font-medium">Cart</button>
              <span>/</span>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
                  ...
                  {cartItems.map((item, index) => (
                    ...
                    >
                      ...
                      <div className="flex items-center space-x-2 mr-4">
                        <button className="w-10 h-8 bg-gray-100 hover:bg-gray-200 border border-gray-200 rounded flex items-center justify-center transition-colors">
                      ...
                      {/* Remove Button */}
                      <button className="w-8 h-8 bg-red-100 hover:bg-red-200 text-red-500 hover:text-red-700 rounded flex items-center justify-center transition-colors">
            ...
            <div className="space-y-6">
              ...
              <div 
                className={`bg-white rounded-xl p-6 border border-gray-200 transition-all duration-1000 ease-out ${
                  isVisible.userInfo ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'
                }`}
                data-section="userInfo"
              >
                <h3 className="font-bold text-xl text-gray-900 mb-6">User Information</h3>
              ...
              >
                <h3 className="font-bold text-xl text-gray-900 mb-6">Payment Summary</h3>
