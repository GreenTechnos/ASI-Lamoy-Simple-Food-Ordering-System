        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              <div
                className={`bg-white rounded-xl p-6 sm:p-8 border border-gray-200 h-full flex flex-col transition-all duration-1000 ease-out ${
                  isVisible.tracking
                    ? "opacity-100 translate-y-0"
                  ...
                  <div className="space-y-6 flex-grow">
                    {trackingSteps.map((step, index) => (
                      <div
                        ...
                        style={{
                          transitionDelay: isVisible.tracking
                            ? `${200 + index * 100}ms`
                            : "0ms",
                        }}
                      >
            ...
            <div className="lg:col-span-1">
              <div
                className={`bg-white rounded-xl border border-gray-200 p-6 sticky top-4 h-full flex flex-col transition-all duration-1000 ease-out ${
                  isVisible.details
                    ? "opacity-100 translate-y-0"
                    : "opacity-0 translate-y-12"
                }`}
                            ...
                            <img
                              ...
                              onError={(e) => {
                                ...
                                e.target.parentElement.innerHTML =
                                  '<svg class="w-6 h-6 text-yellow-600" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"/></svg>';
                              }}
                            />
                          ) : (
                            <svg
