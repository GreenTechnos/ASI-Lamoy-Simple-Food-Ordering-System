            ...
            <div className="lg:col-span-2">
              <div 
                className={`bg-white rounded-xl p-8 border border-gray-200 transition-all duration-1000 ease-out ${
                  isVisible.tracking ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'
                }`}
                  ...
                  {order.trackingSteps.map((step, index) => (
                    <div 
                      ...
                      className={`flex items-start space-x-4 transition-all duration-500 ease-out ${
                        isVisible.tracking ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
                      }`}
                      style={{ 
                    ...
                    >
                      ...
                      <div className="flex-grow">
                        ...
                        <p className={`text-xs font-medium mt-1 ${
                          step.completed || step.current ? 'text-yellow-600' : 'text-gray-400'
                        }`}>
                          {step.time}
                        </p>
                      </div>
